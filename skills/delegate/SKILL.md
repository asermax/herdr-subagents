...
```
${CLAUDE_PLUGIN_ROOT}/bin/herdr-helper spawn --kind <pi|claude> [--agent <name>] --label "<title>" [--model <model>] [--body "<supervisor-agent>… your task …</supervisor-agent>" | --body-file <path>] [--worktree [--branch <name>] [--base <ref>]]
${CLAUDE_PLUGIN_ROOT}/bin/herdr-helper prompt <pane_id> (--body "<supervisor-agent>… your task …</supervisor-agent>" | --body-file <path>)
